...
public class RedisUtils {
     ...
     * @param listKey
     */
    public static void addToListRight(String listKey, long expiretime, TimeUnit unit, Object... values) {
        //绑定操作
        BoundListOperations<String, Object> boundValueOperations = redisTemplate.boundListOps(listKey);
        //插入数据
        boundValueOperations.rightPushAll(values);
        //设置过期时间
        boundValueOperations.expire(expiretime, unit);
    }
